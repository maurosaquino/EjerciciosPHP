...
$pasajero4 = new Pasajero('Arena Castellanos', 'Agustinita', '39068423', FALSE);

$pasajero5 = new Pasajero('Arena Castellanos', 'Jorge', '54068423', FALSE);


$vuelo1 = new Vuelo('AA',500,2);
